...
{
	if (hour1 < 0 || minute1 < 0 || second1 < 0 || hour2 < 0 || minute2 < 0
		|| second2 < 0 || hour1 >= 24 || minute1 >= 60 || second1 >= 60
		|| hour2 >= 24 || minute2 >= 60 || second2 >= 60)
	{
		return -1;
	}

	int seconds = (hour2 - hour1) * 3600 + (minute2 - minute1) * 60 + second2 - second1;
